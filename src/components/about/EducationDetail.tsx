                ...
                <div className="flex-grow">
                  ...
                  <div className="flex justify-between items-center mb-3">
                    ...
                    <h2 className="text-2xl leading-snug font-extrabold text-gray-800 dark:text-gray-100 truncate mb-1 sm:mb-0">
                      <BuildingOfficeIcon className="w-6 h-6 inline-block mr-2" />
                      {detail.schoolName}
                    </h2>
                    {/* Duration */}
                    <div className="flex items-center space-x-2">
                      <CalendarDaysIcon className="w-6 h-6 text-gray-400 dark:text-gray-300" />
                  ...
                  <div className="mb-2 text-xl font-semibold text-gray-700 dark:text-gray-200">
                    <AcademicCapIcon className="w-6 h-6 inline-block mr-2" />
                    {detail.courseName}
                  </div>
                  {/* Location */}
